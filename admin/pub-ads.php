...
<head>
    ...
    <title><?php echo $site_title; ?> - Published Ads</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
            <h4 class="page-header">Published Ads</h4>
        </div>
            </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  ...
                                  $stmt = $conn->prepare("SELECT * FROM tbl_ads LEFT JOIN tbl_sup ON tbl_sup.user_id = tbl_ads.author");
                                  $stmt->execute();
                                             ...
                                             <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a target="_blank" href="../ad/<?php echo $row['ad_id'];?>">View Ad</a>
                                                        <?php
                                                        if ($status == "active") { 
                                               ?> <li><a href="app/make-inact.php?url=pub-ads.php&node=<?php echo $row['ad_id'];?>">Make Inactive</a><?php
                                                        }else{
                                               ?> <li><a href="app/make-act.php?url=pub-ads.php&node=<?php echo $row['ad_id'];?>">Make Active</a><?php
                                                        }
                                                        ...
                                                        ?>
                                                         ...
                                                         <?php
                                                        if ($featured == "yes") { 
                                               ?> <li><a href="app/remov-feat.php?url=pub-ads.php&node=<?php echo $row['ad_id'];?>">Remove Featured</a><?php
                                                        }else{
                                               ?> <li><a href="app/make-feat.php?url=pub-ads.php&node=<?php echo $row['ad_id'];?>">Make Featured</a><?php
                                                        }

                                                        ?>
                                                        <li><a onclick = "return confirm('Delete Ad ?');" href="app/drp-ad.php?url=pub-ads.php&node=<?php echo $row['ad_id'];?>">Delete</a>
                                                    </li>
